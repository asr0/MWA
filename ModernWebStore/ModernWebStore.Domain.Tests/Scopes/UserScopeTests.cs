...
namespace ModernWebStore.Tests.Domain.Scopes
{
    ...
    {
        private User _validUser = new User("asro@hotmail.com", "123456", true);
        private User _invalidPasswordUser = new User("sander.asro@hotmail.com", "", true);
        ...
        {
            var isValid = UserScopes.AuthenticateUserScopeIsValid(_validUser, "sander.asro@hotmail.com", StringHelper.Encrypt("123456"));
        ...
        {
            Assert.AreEqual(false, UserScopes.AuthenticateUserScopeIsValid(_validUser, "sander.asro@gmail.com", "123456"));
        }
    }
}
